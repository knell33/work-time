        ...
        <nav>
            ...
            <li>
                <a href="#phone" data-item="0">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="64px" height="64px" viewBox="0 0 64 64" enable-background="new 0 0 64 64">
						...
						H20.997c-2.026,0-3.668-1.622-3.668-3.625V6.625C17.329,4.624,18.971,3,20.997,3h22.007c2.024,0,3.667,1.624,3.667,3.625V57.375z"></path>
                            <line fill="none" stroke="#fff" stroke-width="6" stroke-miterlimit="10" x1="20" y1="47" x2="44" y2="47"></line>
                                <line fill="none" stroke="#fff" stroke-width="6" stroke-miterlimit="10" x1="20" y1="12" x2="44" y2="12"></line>
                                    <circle fill="#fff" cx="32" cy="54" r="3"></circle>
                    </svg>
                    <span>Phone</span>
                </a>
            </li>
            <li>
                <a href="#music" data-item="1">
					...
					C4,52.056,8.255,48.612,13.5,48.612z"></path>
					...
					C41,42.066,45.252,38.621,50.503,38.621z"></path>
                                    <line fill="none" stroke="#fff" stroke-width="6" stroke-miterlimit="10" x1="20" y1="27.163" x2="57.016" y2="16.362"></line>
                    </svg>
                    <span>Music</span>
                </a>
            </li>
            <li>
                <a href="#map" data-item="2">
					...
					s3.255-7.27,7.271-7.27s7.269,3.255,7.269,7.27S36.002,27.637,31.986,27.637z"></path>
                    </svg>
                    <span>Map</span>
                </a>
            </li>
            ...
            <li>
                <a href="#settings" data-item="4">
					...
					c0-7.374,5.977-13.351,13.351-13.351c7.37,0,13.352,5.977,13.352,13.351C45.58,39.675,39.599,45.654,32.229,45.654z"></path>
                    </svg>
                    <span>Settings</span>
                </a>
            </li>
